...
export default function GradientOrbs({ orbs }: GradientOrbsProps) {
  const defaultOrbs = [
    { color: "bg-accent/10", position: "top-1/4 -left-32", size: "w-64 sm:w-96 h-64 sm:h-96" },
    { color: "bg-purple/10", position: "bottom-1/4 -right-32", size: "w-64 sm:w-96 h-64 sm:h-96" },
  ];
